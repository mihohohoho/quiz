    ...
    <body>
        <div class="p-md-3">
            <div class="card">
                ...
                <div class="p-md-3">
                    <form action="/quizzes" method="POST" enctype='multipart/form-data' class="form-inline">
                        @csrf
                        <div class="title p-md-3">
                            <p class="font-weight-bold">問題文</p>
                            <textarea class="form-control" name="quiz[title]" rows="4" cols="40" placeholder="問題を入力してください" >{{ old('quiz.title') }}</textarea>
                        ...
                        <div class="choice p-md-3">
                            ...
                            選択肢1：<input class="form-control" type="text" name="quiz[choice1]" id="choice1" placeholder="選択肢1" value="{{ old('quiz.choice1') }}"/>
                            <p class="font-weight-bold" class="title__error" style="color:red">{{ $errors->first('quiz.choice1') }}</p>
                            選択肢2：<input class="form-control" type="text" name="quiz[choice2]" id="choice2" placeholder="選択肢2" value="{{ old('quiz.choice2') }}"/>
                            <p class="font-weight-bold" class="title__error" style="color:red">{{ $errors->first('quiz.choice2') }}</p>
                            選択肢3：<input class="form-control" type="text" name="quiz[choice3]" id="choice3" placeholder="選択肢3" value="{{ old('quiz.choice3') }}"/>
                        ...
                        <div class="explanation p-md-3">
                            ...
                            <textarea class="form-control" name="quiz[explanation]" rows="4" cols="40" placeholder="解説を入力してください">{{ old('quiz.explanation') }}</textarea>
                        ...
                        <div class="tag_create p-md-3">
                            ...
                            <textarea class="form-control" name="tags" class="tags">{{ old('tags') }}</textarea>
